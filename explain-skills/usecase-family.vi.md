...
[English](usecase-family.md) · **Tiếng Việt**
...
- `explain-skills/usecase.vi.md` — `/usecase` (viết kịch bản người dùng chi tiết, chuẩn Cockburn).
- `explain-skills/usecase-diagram.vi.md` — `/usecase-diagram` (vẽ bức tranh tổng quan actor + use case).
- `explain-skills/userstory.vi.md` — `/userstory` (chia công việc thành user story cho backlog).
