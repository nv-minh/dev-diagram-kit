...
[English](activity-swimlane.md) · **Tiếng Việt**
...
- `explain-skills/activity.vi.md` — lệnh `/activity` (công cụ Mermaid): nhẹ nhất, nhúng thẳng vào tài liệu và tự hiện hình trên GitHub/Obsidian. Hợp luồng **gọn, 1-2 vai trò**.
- `explain-skills/d2-activity.vi.md` — lệnh `/d2-activity` (công cụ D2): vẽ **hình đẹp đứng riêng** để đưa cho sếp/khách xem hoặc xuất ra file.
- `explain-skills/activity-family.vi.md` — bài so sánh tổng hợp cả ba lệnh, giúp bạn chọn đúng lệnh cho từng tình huống.
