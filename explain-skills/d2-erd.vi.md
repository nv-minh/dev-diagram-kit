...
- `explain-skills/erd.vi.md` — vẽ sơ đồ dữ liệu bằng Mermaid, **nhúng thẳng vào tài liệu** để GitHub/Obsidian tự hiện.
- `.claude/skills/dbdiagram/SKILL.md` — sơ đồ dữ liệu **gần với lập trình** (kiểu database thật, xuất SQL), dùng khi bàn giao cho dev.
- `explain-skills/d2-activity.vi.md` — cùng công cụ D2 nhưng vẽ **sơ đồ quy trình** (từng bước một việc chạy thế nào), thay vì sơ đồ dữ liệu.
