...
[English](d2-activity.md) · **Tiếng Việt**
...
- `explain-skills/activity.vi.md` — vẽ quy trình bằng Mermaid, **nhúng thẳng vào tài liệu** để GitHub/Obsidian tự hiện.
- `explain-skills/activity-swimlane.vi.md` — vẽ "phân làn thật" cho quy trình **nhiều vai trò**, lựa chọn mặc định khi nhiều tương tác qua lại.
- `explain-skills/activity-family.vi.md` — so sánh tổng quan cả họ lệnh vẽ quy trình, giúp chọn đúng lệnh cho từng tình huống.
