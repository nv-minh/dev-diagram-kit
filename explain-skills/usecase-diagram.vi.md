...
[English](usecase-diagram.md) · **Tiếng Việt**
...
- `explain-skills/usecase-family.vi.md` — **cái nhìn tổng**: `/usecase`, `/usecase-diagram`, `/userstory` liên quan với nhau thế nào.
- `explain-skills/usecase.vi.md` — mô tả chi tiết từng kịch bản người dùng.
- `explain-skills/userstory.vi.md` — chuyển yêu cầu và use case thành backlog-draft.
