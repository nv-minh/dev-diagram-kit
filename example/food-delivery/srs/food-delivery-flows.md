...
> Bản mẫu do bộ **dev-diagram-kit** sinh ra. Mỗi flow một section. Sequence diagram (output `/sequence`) và activity/flowchart (output `/activity`) cùng sống trong file này — theo quy ước `srs/{feature}-flows.md`.
>
