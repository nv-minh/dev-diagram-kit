...
For **document skills**, each skill ships a **simulated session** (realistic chat transcript with L1/L2 gates) at `skills/<skill>/references/example-session.md`. Start from the full index in [06 — BA documents](06-ba-documents.md) and [07 — API & delivery](07-api-and-delivery.md).
